...
@Component
public class Test1Repository implements ShardEntityRepository<TestBShardEntity> {
    ...
    @Autowired
    Test1Repository(ShardDataBaseManager dataBaseManager, ProfilerService profiler, TestC2Repository testC2Repository) {
    ...
    private List<TestBShardEntity> findAll(ResultQuery result, Map<String, DataStorage> storageMap) {
        ...
        try {
            ...
            if (!entities.isEmpty()) {
                ...
                Lists.partition(entities, 1000)
                        .forEach(partEntities -> {
                            profiler.startTimeCounter("getCList", "AAA");
                            profiler.startTimeCounter("testC2Repository.findAll", "AAA");
