...
/*
    ...
    <T extends Domain> Iterable<T> findAll(Class<T> clazz, String condition, Object... binds);
    <T extends Domain> Iterable<T> findAll(Class<T> clazz, ShardInstance parent, String condition, Object... binds);
